      ...
      <div className="page-header">
        <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-2">
            {isAdmin && (
              <>
                <button onClick={handleExportCSV} className="flex items-center gap-2 px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-lg text-sm font-medium transition backdrop-blur-sm">
        ...
        <>
          ...
          <div className="slide-panel slide-panel-active bg-white dark:bg-gray-800 shadow-2xl z-50">
            ...
            <div className="p-5 space-y-4 overflow-y-auto max-h-[calc(100vh-130px)]">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-medium text-gray-600 dark:text-gray-400">Joining Date</label>
              ...
              <div>
                <label className="text-xs font-medium text-gray-600 dark:text-gray-400">Reporting Manager</label>
